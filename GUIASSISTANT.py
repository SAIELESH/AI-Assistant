...
if __name__ == '__main__':
	...
	clearFaceBtn = Button(settingsFrame, text='   Close the L.A.T.H.A   ', bd=0, font=('Arial 12'), fg='white', bg='#14A769', relief=FLAT, command=deleteUserData)

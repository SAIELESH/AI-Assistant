...
if __name__ == '__main__':
    ...
    # welcome label
    welcLbl = Label(root1, text='Hi there,\nWelcome to the digital world', font=('Arial Bold', 15),
    ...
    usernameLbl = Label(root4, text="Sailesh Krishnan", font=('Arial Bold', 15), bg=background, fg='#85AD4F')
    ...
    Label(root4, text="Launch the APP again to get started the conversation with your AI Assistant",
